              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2">Zapomněli jste heslo?</h1>
                    <p class="mb-4">Zadejte svou e-mailovou adresu níže a my vám pošleme odkaz pro obnovení hesla!</p>
                  </div>
                    @if (session('status'))
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="{{route('login')}}">Už máte účet? Přihlašte se!</a>
                  </div>
                </div>
              </div>
            </div>
